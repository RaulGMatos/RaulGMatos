...
if( isset( $_GET['submit'] ) )
    {
		...
		// Query to determine if a user exists in our database.
		$sql = "SELECT count(*) FROM formvalid1 WHERE userperson = ?";
        ...
        if($stmt->execute(array($_GET['box1'])))
        {
		 ...
		 // stack overflow url on fetchColumn(): http://stackoverflow.com/questions/883365/row-count-with-pdo
	...
	print "<form method='get' action='pdo04.php'>";
